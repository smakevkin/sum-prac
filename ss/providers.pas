...
begin
  ...
  if err_string = '' then begin
    ...
    // Проверка на длину наименования заказчика (не больше 20)
    if t_s.Length > 20 then append_err(err_string, 'НАИМЕНОВАНИЕ ЗАКАЗЧИКА: Длина наименования заказчика не может быть больше 20 символов.');
